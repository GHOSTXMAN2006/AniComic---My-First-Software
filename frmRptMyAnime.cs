...
namespace Software
{
    public partial class frmRptMyAnime : Form
    {
        public frmRptMyAnime()
        {
            InitializeComponent();
        }

        private void frmRptMyAnime_Load(object sender, EventArgs e)
        {
            // Load the report file directly into the viewer
            this.crystalReportViewer1.ReportSource = @"D:\=------NIBM WORK-----=\DSE - Niviru - Acer\GAD\GAD Coursework\Software\CrystalReport2.rpt";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                try
                {
                    ...
                    string sql = "SELECT * FROM tblAnime WHERE 1=1";
                    ...
                    rpt.Load(@"D:\=------NIBM WORK-----=\DSE - Niviru - Acer\GAD\GAD Coursework\Software\CrystalReport2.rpt");
